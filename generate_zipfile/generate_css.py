...
def generate_css(input_param):
    ...
    result += css_top(top, input_param)
...
def css_top(top, input_param):
    ...
    logo_background = input_param['lg']['background-color']
    title_background = input_param['tt']['background-color']

    if len(input_param['orderTopThree']) == 3:
        top_width = "33.3%"
    elif len(input_param['orderTopThree']) == 2:
        top_width = "50%"
    elif len(input_param['orderTopThree']) == 1:
        top_width = "100%"
...
def css_bottom(bottom, input_param):
    ...
    bottom_width = "0"
    question_background = input_param['qu']['background-color']
    transcript_background = input_param['ts']['background-color']
    footnote_background = input_param['fn']['background-color']
